  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <h1 className="text-4xl font-bold leading-tight tracking-tight md:text-5xl">
              Word search puzzles,
              <br />
              <span className="text-indigo-600">made to print.</span>
            </h1>
            <p className="mt-6 max-w-md text-lg leading-relaxed text-slate-600">
              Pick a language, choose how many pages you need, and get a
              print-ready A4 sheet — three puzzles per page, no clutter on the
              paper.
            </p>
            <div className="mt-8 flex items-center gap-4">
              ...
              <span className="text-sm text-slate-500">
                Free · no account · prints locally in your browser
              </span>
            </div>
          </div>
      ...
      <footer className="mx-auto flex max-w-6xl items-center justify-between px-6 py-8 text-xs text-slate-400">
        <span>Word Search — generated for you, printed on your printer.</span>
